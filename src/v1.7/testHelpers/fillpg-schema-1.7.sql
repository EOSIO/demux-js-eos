...
CREATE TABLE "${schema^}".account (
    ...
    code_version character varying(64),
...
--
-- Name: b1_sponsorships; Type: TABLE; Schema: "${schema^}"; Owner: docker
--

CREATE TABLE "${schema^}".b1_sponsorships (
    block_index bigint NOT NULL,
    present boolean NOT NULL,
    primary_key numeric NOT NULL,
    key numeric,
    ...
    entity_type smallint,
    entity_id bigint,
    sponsor character varying(13),
    paid bigint,
    sponsor_count integer,
    create_time timestamp without time zone,
    last_sponsor_time timestamp without time zone
);


ALTER TABLE "${schema^}".b1_sponsorships OWNER TO "docker";
...
ALTER TABLE ONLY "${schema^}".account
    ADD CONSTRAINT account_pkey PRIMARY KEY (block_index, present, name);
...
ALTER TABLE ONLY "${schema^}".action_trace_auth_sequence
    ADD CONSTRAINT action_trace_auth_sequence_pkey PRIMARY KEY (block_index, transaction_id, action_index, index);
...
ALTER TABLE ONLY "${schema^}".action_trace_authorization
    ADD CONSTRAINT action_trace_authorization_pkey PRIMARY KEY (block_index, transaction_id, action_index, index);
...
ALTER TABLE ONLY "${schema^}".action_trace
    ADD CONSTRAINT action_trace_pkey PRIMARY KEY (block_index, transaction_id, action_index);
...
ALTER TABLE ONLY "${schema^}".action_trace_ram_delta
    ADD CONSTRAINT action_trace_ram_delta_pkey PRIMARY KEY (block_index, transaction_id, action_index, index);
...
ALTER TABLE ONLY "${schema^}".b1_account
    ADD CONSTRAINT b1_account_pkey PRIMARY KEY (block_index, present, primary_key);
...
ALTER TABLE ONLY "${schema^}".b1_accounts
    ADD CONSTRAINT b1_accounts_pkey PRIMARY KEY (block_index, present, primary_key);
...
ALTER TABLE ONLY "${schema^}".b1_accountstat
    ADD CONSTRAINT b1_accountstat_pkey PRIMARY KEY (block_index, present, primary_key);
...
ALTER TABLE ONLY "${schema^}".b1_activelikes
    ADD CONSTRAINT b1_activelikes_pkey PRIMARY KEY (block_index, present, primary_key);
...
ALTER TABLE ONLY "${schema^}".b1_categories
    ADD CONSTRAINT b1_categories_pkey PRIMARY KEY (block_index, present, primary_key);
...
ALTER TABLE ONLY "${schema^}".b1_moderators
    ADD CONSTRAINT b1_moderators_pkey PRIMARY KEY (block_index, present, primary_key);
...
ALTER TABLE ONLY "${schema^}".b1_mtndellike
    ADD CONSTRAINT b1_mtndellike_pkey PRIMARY KEY (block_index, present, primary_key);
...
ALTER TABLE ONLY "${schema^}".b1_mtndellikes
    ADD CONSTRAINT b1_mtndellikes_pkey PRIMARY KEY (block_index, present, primary_key);
...
ALTER TABLE ONLY "${schema^}".b1_rewardstat
    ADD CONSTRAINT b1_rewardstat_pkey PRIMARY KEY (block_index, present, primary_key);
...
ALTER TABLE ONLY "${schema^}".b1_rptdecisions
    ADD CONSTRAINT b1_rptdecisions_pkey PRIMARY KEY (block_index, present, primary_key);
...
ALTER TABLE ONLY "${schema^}".b1_rptreasons
    ADD CONSTRAINT b1_rptreasons_pkey PRIMARY KEY (block_index, present, primary_key);


--
-- Name: b1_sponsorships b1_sponsorships_pkey; Type: CONSTRAINT; Schema: "${schema^}"; Owner: docker
--

ALTER TABLE ONLY "${schema^}".b1_sponsorships
    ADD CONSTRAINT b1_sponsorships_pkey PRIMARY KEY (block_index, present, primary_key);
...
ALTER TABLE ONLY "${schema^}".b1_tokenstat
    ADD CONSTRAINT b1_tokenstat_pkey PRIMARY KEY (block_index, present, primary_key);
...
ALTER TABLE ONLY "${schema^}".b1_userlikes
    ADD CONSTRAINT b1_userlikes_pkey PRIMARY KEY (block_index, present, primary_key);
...
ALTER TABLE ONLY "${schema^}".block_info
    ADD CONSTRAINT block_info_pkey PRIMARY KEY (block_index);
...
ALTER TABLE ONLY "${schema^}".contract_index128
    ADD CONSTRAINT contract_index128_pkey PRIMARY KEY (block_index, present, code, scope, "table", primary_key);
...
ALTER TABLE ONLY "${schema^}".contract_index256
    ADD CONSTRAINT contract_index256_pkey PRIMARY KEY (block_index, present, code, scope, "table", primary_key);
...
ALTER TABLE ONLY "${schema^}".contract_index64
    ADD CONSTRAINT contract_index64_pkey PRIMARY KEY (block_index, present, code, scope, "table", primary_key);
...
ALTER TABLE ONLY "${schema^}".contract_index_double
    ADD CONSTRAINT contract_index_double_pkey PRIMARY KEY (block_index, present, code, scope, "table", primary_key);
...
ALTER TABLE ONLY "${schema^}".contract_index_long_double
    ADD CONSTRAINT contract_index_long_double_pkey PRIMARY KEY (block_index, present, code, scope, "table", primary_key);
...
ALTER TABLE ONLY "${schema^}".contract_row
    ADD CONSTRAINT contract_row_pkey PRIMARY KEY (block_index, present, code, scope, "table", primary_key);
...
ALTER TABLE ONLY "${schema^}".contract_table
    ADD CONSTRAINT contract_table_pkey PRIMARY KEY (block_index, present, code, scope, "table");
...
ALTER TABLE ONLY "${schema^}".generated_transaction
    ADD CONSTRAINT generated_transaction_pkey PRIMARY KEY (block_index, present, sender, sender_id);
...
ALTER TABLE ONLY "${schema^}".global_property
    ADD CONSTRAINT global_property_pkey PRIMARY KEY (block_index, present);
...
ALTER TABLE ONLY "${schema^}".permission_link
    ADD CONSTRAINT permission_link_pkey PRIMARY KEY (block_index, present, account, code, message_type);
...
ALTER TABLE ONLY "${schema^}".permission
    ADD CONSTRAINT permission_pkey PRIMARY KEY (block_index, present, owner, name);
...
ALTER TABLE ONLY "${schema^}".received_block
    ADD CONSTRAINT received_block_pkey PRIMARY KEY (block_index);
...
ALTER TABLE ONLY "${schema^}".resource_limits_config
    ADD CONSTRAINT resource_limits_config_pkey PRIMARY KEY (block_index, present);
...
ALTER TABLE ONLY "${schema^}".resource_limits
    ADD CONSTRAINT resource_limits_pkey PRIMARY KEY (block_index, present, owner);
...
ALTER TABLE ONLY "${schema^}".resource_limits_state
    ADD CONSTRAINT resource_limits_state_pkey PRIMARY KEY (block_index, present);
...
ALTER TABLE ONLY "${schema^}".resource_usage
    ADD CONSTRAINT resource_usage_pkey PRIMARY KEY (block_index, present, owner);
...
ALTER TABLE ONLY "${schema^}".transaction_trace
    ADD CONSTRAINT transaction_trace_pkey PRIMARY KEY (block_index, transaction_id);
